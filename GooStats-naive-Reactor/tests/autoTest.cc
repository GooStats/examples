...
void trigger_fit(const std::string arg1 = "reactor", const std::string arg2 = "data_recE.cfg",
                 const std::string arg3 = "NLLValid",
                 const std::string arg4 = "inputSpectraFiles=data/data_hist.root",
                 const std::string arg5 = "main_histName=Evis_hist_poissonAppSum",
                 const std::string arg6 = "", const std::string arg7 = "", const std::string arg8 = "",
                 const std::string arg9 = "",
                 const std::string arg10 = "", const std::string arg11 = "", const std::string arg12 = "",
                 const std::string arg13 = "",
                 const std::string arg14 = "", const std::string arg15 = "", const std::string arg16 = "",
                 const std::string arg17 = "",
                 const std::string arg18 = "", const std::string arg19 = "", const std::string arg20 = "",
                 const std::string arg21 = "") {
    int argc(0);
    char **argv;
    argv = new char *[21];
    for (int i = 0; i < 21; ++i) argv[i] = new char[255];
    if (arg1 != "") {
        std::strcpy(argv[argc], arg1.c_str());
        ++argc;
    }
    if (arg2 != "") {
        std::strcpy(argv[argc], arg2.c_str());
        ++argc;
    }
    if (arg3 != "") {
        std::strcpy(argv[argc], arg3.c_str());
        ++argc;
    }
    if (arg4 != "") {
        std::strcpy(argv[argc], arg4.c_str());
        ++argc;
    }
    if (arg5 != "") {
        std::strcpy(argv[argc], arg5.c_str());
        ++argc;
    }
    if (arg6 != "") {
        std::strcpy(argv[argc], arg6.c_str());
        ++argc;
    }
    if (arg7 != "") {
        std::strcpy(argv[argc], arg7.c_str());
        ++argc;
    }
    if (arg8 != "") {
        std::strcpy(argv[argc], arg8.c_str());
        ++argc;
    }
    if (arg9 != "") {
        std::strcpy(argv[argc], arg9.c_str());
        ++argc;
    }
    if (arg10 != "") {
        std::strcpy(argv[argc], arg10.c_str());
        ++argc;
    }
    if (arg11 != "") {
        std::strcpy(argv[argc], arg11.c_str());
        ++argc;
    }
    if (arg12 != "") {
        std::strcpy(argv[argc], arg12.c_str());
        ++argc;
    }
    if (arg13 != "") {
        std::strcpy(argv[argc], arg13.c_str());
        ++argc;
    }
    if (arg14 != "") {
        std::strcpy(argv[argc], arg14.c_str());
        ++argc;
    }
    if (arg15 != "") {
        std::strcpy(argv[argc], arg15.c_str());
        ++argc;
    }
    if (arg16 != "") {
        std::strcpy(argv[argc], arg16.c_str());
        ++argc;
    }
    if (arg17 != "") {
        std::strcpy(argv[argc], arg17.c_str());
        ++argc;
    }
    if (arg18 != "") {
        std::strcpy(argv[argc], arg18.c_str());
        ++argc;
    }
    if (arg19 != "") {
        std::strcpy(argv[argc], arg19.c_str());
        ++argc;
    }
    if (arg20 != "") {
        std::strcpy(argv[argc], arg20.c_str());
        ++argc;
    }
    if (arg21 != "") {
        std::strcpy(argv[argc], arg21.c_str());
        ++argc;
    }
...
TEST_F(BestFitFixture, TAUP_npmt_near) {
    trigger_fit("reactor", "data_recE.cfg", "NLLValid", "inputSpectraFiles=data/data_hist.root",
                "main_histName=Evis_hist_poissonAppSum", "seed=1",
                "deltaM231_err=0.18", "deltaM221_err=0.18",
                "pullPars=deltaM231", "NReactor_min=0.9", "NReactor_max=1.0");
...
TEST_F(BestFitFixture, Asimov_near) {
    trigger_fit("reactor", "data_recE.cfg", "NLLValidHTAsimov", "inputSpectraFiles=data/data_hist.root",
                "main_histName=Evis_hist_poissonAppSum", "seed=1",
...
TEST_F(BestFitFixture, toyMC_near) {
    trigger_fit("reactor", "data_recE.cfg", "NLLValidHTRND", "inputSpectraFiles=data/data_hist.root",
                "main_histName=Evis_hist_poissonAppSum", "seed=1",
                "fitFakeData=true", "repeat=2", "seed=1", "fitNMO=true", "SimpleFit=false");
    load_species(species);
